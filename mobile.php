...
<title>Mobile City | Mobiles</title>
...
<h1 style="font-weight:bold; color: #B22222; font-size:24pt;"> <?php echo $brand_name; ?></h1>
...
$query = "SELECT * FROM mobiles_data where brand='".$brand_name."'";
